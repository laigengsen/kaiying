<?php /*a:1:{s:76:"D:\phpstudy_pro\WWW\qiyezhan\application\user\view\index\contactkaiying.html";i:1571497249;}*/ ?>
<!DOCTYPE html>
...
<div class="product">
    ...
    <div class="products">
        <center>
            <div><p style="font-size: 30px;color: black">关于凯盈</p></div>
        </center>



        <div style="font-size: 20px;width: 30%;height: 100%;float: left">
            <div class="center">
                <div class="class_product">
                    <div class="page_right">
                        <div class="page_rightContent">
                            <div class="home_title"><div class="home_title_bj"><p style="color: black">公司地址</p></div></div>
                            <div class="page_contact">
                                <div class="maps"> <div style="width:397px;height:433px;border:#ccc solid 1px;font-size:12px" id="map"></div></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style="padding: 30px;font-size: 20px;width: 50%;height: 100%;float: right;color: black">
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=DB9383b8c935da6d3671f2a0bff9ea48"></script>
<script type="text/javascript">
    ...
    function createMap() {
        ...
        map.centerAndZoom(new BMap.Point(118.549631, 24.823957), 17);
    }
    ...
    function addMapOverlay() {
        var markers = [
            { content: " <p>地址：福建省泉州市晋江市西园街道砌田工业区 </p>                    <p>联系电话：0595-85064250</p>                    <p>联系人：张总（电话：15960739600）</p>                    <p>传真：0595-85064270</p>                    <p>邮箱：283039732@qq.com</p>", title: "凯盈汽车零部件有限公司", imageOffset: { width: -46, height: 3 }, position: { lat: 24.824432, lng: 118.548625} }
        ];
