...
<div class="product">
    <div class="productcate" style="padding-left: 50px;padding-top: 50px;background-color: pink;color: white">
        <ul>
            <li style="font-size: 35px;margin-bottom: 40px;border-bottom: 1px solid black;color: black"><a>新闻分类</a></li>
    ...
    <div class="products">
        <div class="newsbody">
            ...
            <div style="font-size: 20px;width: 100%;color: black" id="producttitle"><a><?php echo htmlentities($vo2['producttitle']); ?></a></div>
