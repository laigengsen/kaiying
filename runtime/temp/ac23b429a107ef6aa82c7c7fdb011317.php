<?php /*a:1:{s:69:"D:\phpstudy_pro\WWW\qiyezhan\application\user\view\index\kaiying.html";i:1571554161;}*/ ?>
<!DOCTYPE html>
...
<div class="product">
    ...
    <div class="products">
        <div><p style="font-size: 30px;color: black">高强度产品推荐</p></div>
        <div>
            <div>
...
<div class="dongtai">
    ...
    <div>
        <img src="/static/user/websiteDemo/images/404_img.png">
    </div>
    <div>
        <ul class="dongtainews">
